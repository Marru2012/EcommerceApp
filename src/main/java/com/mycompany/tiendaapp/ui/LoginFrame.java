...
public class LoginFrame extends JFrame {
    ...
    private JPanel construirPanelLogin() {
        ...
        g.gridx=1;             p.add(txtEmail, g);

        g.gridx=0; g.gridy=3; p.add(new JLabel("Contrasena:"), g);
        g.gridx=1;             p.add(txtPass, g);
        ...
        g.gridy=5; btnIrRegistro.setFont(new Font("Arial", Font.PLAIN, 11));
    ...
    private JPanel construirPanelRegistro() {
        ...
        g.gridx=1;             p.add(txtRegNombre, g);

        g.gridx=0; g.gridy=2; p.add(new JLabel("Email:"), g);
        g.gridx=1;             p.add(txtRegEmail, g);

        g.gridx=0; g.gridy=3; p.add(new JLabel("Contrasena:"), g);
        g.gridx=1;             p.add(txtRegPass, g);

        g.gridx=0; g.gridy=4; p.add(new JLabel("Confirmar:"), g);
        g.gridx=1;             p.add(txtRegPass2, g);
